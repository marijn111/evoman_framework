...
if __name__ == "__main__":
    ...
    for e, enemy_group in enumerate(enemy_groups):
        for i in range(num_experiments):
            ...
            for enem in range(1, num_enemies+1):
                mean_total_gain = 0
                ...
                total_gain_neat += mean_total_gain / num_best_solution_runs
            mean_gain = total_gain_neat / num_enemies
    ...
    for e, enemy_group in enumerate(enemy_groups):
        for i in range(num_experiments):
            ...
            mean_gain = total_gain_neuro / num_enemies
